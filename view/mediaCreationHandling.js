const input_select_type_div = document.querySelector("#select_type_div")
const input_select_format = document.querySelector("#media_format")
let input_select_type = document.querySelector("#media_type")
const input_optionnel_div = document.querySelector("#optionnel")
let input_contenu_div = document.querySelector("#contenu")
...
function setOptionnelToLivre() {
    ...
    newLabel_1.setAttribute("for", "media_editor")
    ...
    newInput_1.id = "media_editor"
    newInput_1.name = "media_editor"
    newDiv.appendChild(newInput_1)

    let newLabel_2 = document.createElement('label')
    newLabel_2.setAttribute("for", "media_edition")
    ...
    newInput_2.id = "media_edition"
    newInput_2.name = "media_edition"
...
function setOptionnelToAudio() {
    ...
    newLabel_3.setAttribute("for", "duration")
    ...
    newInput_3.id = "media_duration"
    newInput_3.name = "media_duration"
...
function setOptionnelToFilm() {
    ...
    let newLabel_1 = document.createElement('label')
    newLabel_1.setAttribute("for", "media_productor")
    newLabel_1.appendChild(document.createTextNode("Producteur"))
    newDiv.appendChild(newLabel_1)
    let newInput_1 = document.createElement('input')
    newInput_1.setAttribute("type", "text")
    newInput_1.id = "media_productor"
    newInput_1.name = "media_productor"
    newDiv.appendChild(newInput_1)

    let newLabel_2 = document.createElement('label')
    newLabel_2.setAttribute("for", "duration")
    ...
    newInput_2.setAttribute("step", "1")
    newInput_2.id = "media_duration"
    newInput_2.name = "media_duration"
